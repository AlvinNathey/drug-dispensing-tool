...
<body>
    ...
    <img class="logo" src="css/logoremoved.png">
</a>
            <h1> MyDispenser</h1>
            ...
            <ul class="nav">
                ...
                <li class="Anticoagulants <?php if($section == "Anticoagulants"){echo  "on";} ?>">
				  <a href="drug/catalog.php?cat=Anticoagulants">Anti coagulants</a></li>

                <li class="Antibiotics <?php if($section == "Antibiotics"){echo "on";}?>">
				  <a href="drug/catalog.php?cat=Antibiotics">Anti biotics</a></li>
            </ul>
      </div>       
    </header>